      ...
      <>
        ...
        <div className="mt-5 grid grid-cols-1 gap-10 px-10 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="col-span-2 ml-32 w-[50%]">
            <AddExpense budgetId={+budgetId} budgetAmount={+budget.amount} totalAmountSpent={totalAmountSpent} />
          </div>
        </div>
        <div className="px-10">
          <h2 className="text-primary p-2 text-4xl font-semibold">
            Latest Expenses
          </h2>
          {budget.expenses.length === 0 ? (
            <h1 className="text-center font-semibold text-gray-300">No expense to show ...</h1>
          ) : (
